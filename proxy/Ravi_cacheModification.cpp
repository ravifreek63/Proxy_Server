...
#define MAX_OUTSTANDING 114        // Limits the maximum no. of outstanding client connection with proxy server.
#define PARENT_PROXY 0                // Is a parent proxy present?
#define PARENT_PROXY_ADDR "172.16.25.52"        // Address of a parent proxy.
